...
var BaseDemoComponent = /** @class */ (function () {
    function BaseDemoComponent() {
    }
    BaseDemoComponent.prototype.ngOnInit = function () {
    };
    BaseDemoComponent.prototype.ngAfterViewInit = function () {
        var timestamp = (new Date()).getTime().toString();
        var iframeHtmlUrl = '/assets/demos/main-demo/index.html';
        var iframeCssUrl = '/assets/demos/main-demo/styles.css';
        var iframeRtdCssUrl = '/assets/demos/main-demo/styles.rtd.css';
    ...
    BaseDemoComponent.prototype.createIframeUrl = function (timestamp, pageUrl, title, cssUrl, deviceClass) {
        if (deviceClass === void 0) { deviceClass = null; }
        var parts = [pageUrl];
        var queryParams = new _logic_query_params__WEBPACK_IMPORTED_MODULE_2__["QueryParams"]();
...
var QueryParams = /** @class */ (function () {
    ...
    QueryParams.stringify = function (queryParams) {
        if (!queryParams) {
